...
public class TableDescriptionJavaSQLiteTableDAO
{
	...
	public TableDescriptionJavaSQLiteTableDAO(Connection SQLiteDatabaseConnection)
	{
		...
		_deleteDAO = new TableDescriptionJavaSQLiteTableDeleteDAO(SQLiteDatabaseConnection);
		_dropTableDAO = new TableDescriptionJavaSQLiteTableDropDAO(SQLiteDatabaseConnection);
	}
