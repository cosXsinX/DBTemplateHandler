...
public class DatabaseDescriptionJavaSQLiteTableDAO
{
	...
	public DatabaseDescriptionJavaSQLiteTableDAO(Connection SQLiteDatabaseConnection)
	{
		...
		_deleteDAO = new DatabaseDescriptionJavaSQLiteTableDeleteDAO(SQLiteDatabaseConnection);
		_dropTableDAO = new DatabaseDescriptionJavaSQLiteTableDropDAO(SQLiteDatabaseConnection);
	}
