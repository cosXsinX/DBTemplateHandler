...
public class TableColumnDescriptionJavaSQLiteTableDAO
{
	...
	public TableColumnDescriptionJavaSQLiteTableDAO(Connection SQLiteDatabaseConnection)
	{
		...
		_deleteDAO = new TableColumnDescriptionJavaSQLiteTableDeleteDAO(SQLiteDatabaseConnection);
		_dropTableDAO = new TableColumnDescriptionJavaSQLiteTableDropDAO(SQLiteDatabaseConnection);
	}
