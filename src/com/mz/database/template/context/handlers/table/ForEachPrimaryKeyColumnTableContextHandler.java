...
public class ForEachPrimaryKeyColumnTableContextHandler extends AbstractTableTemplateContextHandler {

	public final static String START_CONTEXT_WORD = "{:TDB:TABLE:COLUMN:PRIMARY:FOREACH[";
