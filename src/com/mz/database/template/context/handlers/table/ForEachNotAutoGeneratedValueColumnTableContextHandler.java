...
public class ForEachNotAutoGeneratedValueColumnTableContextHandler extends AbstractTableTemplateContextHandler {

	public final static String START_CONTEXT_WORD = "{:TDB:TABLE:COLUMN:NOT:AUTO:FOREACH[";
