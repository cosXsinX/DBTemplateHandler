...
public class AutoColumnIndexColumnContextHandler extends AbstractColumnTemplateContextHandler {

	private final static String START_CONTEXT_WORD = "{:TDB:TABLE:COLUMN:AUTO:FOREACH:CURRENT:INDEX";
