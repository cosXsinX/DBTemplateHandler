...
public class NotNullColumnIndexColumnContextHandler extends AbstractColumnTemplateContextHandler {

	private final static String START_CONTEXT_WORD = "{:TDB:TABLE:COLUMN:PRIMARY:NOT:NULL:CURRENT:INDEX";
