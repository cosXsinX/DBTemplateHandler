...
public class IsColumnNotAutoGeneratedValueColumnContextHandler2 extends AbstractColumnTemplateContextHandler {

	public final static String START_CONTEXT_WORD = "{:TDB:TABLE:COLUMN:FOREACH:CURRENT:IS:KEY:NOT:AUTO(";
	public final static String END_CONTEXT_WORD = ")KEY:NOT:AUTO:::}";
