...
public class IsColumnNotAFirstColumnContextHandler extends AbstractColumnTemplateContextHandler {

	public final static String START_CONTEXT_WORD = "{:TDB:TABLE:COLUMN:FOREACH:CURRENT:IS:NOT:FIRST:COLUMN(";
	...
	public String processContext(String StringContext) throws Exception {
		...
		if(!descriptionPojo.equals(columnList.get(0)) )
		{
