...
public class IsColumnPrimaryKeyColumnContextHandler extends AbstractColumnTemplateContextHandler {

	public final static String START_CONTEXT_WORD = "{:TDB:TABLE:COLUMN:FOREACH:CURRENT:IS:KEY:PRIMARY(";
	public final static String END_CONTEXT_WORD = ")KEY:PRIMARY:::}";
