...
public class ColumnIndexColumnContextHandler extends AbstractColumnTemplateContextHandler {

	private final static String START_CONTEXT_WORD = "{:TDB:TABLE:COLUMN:FOREACH:CURRENT:INDEX";
	...
	public String processContext(String StringContext) throws Exception {
		...
		return Integer.toString( columnList.indexOf(descriptionPojo));
	}
